...
from mmseg.models.backbones.cswin_checkpoint import load_checkpoint
...
class CSWin(BaseModule):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, embed_dim=64, depth=[1,2,21,1], split_size = 7,
                 ...
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, use_chk=False, pretrained=None, init_cfg=None):
        ...
        super(CSWin, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self, pretrained=None):      
        ...
        if isinstance(pretrained, str):
            ...
            state_dict = load_checkpoint(self, pretrained, strict=False, logger=logger)
            print('=========================== pretrained: ', pretrained)
            print('inside init weight |  state_dict: ', state_dict.keys())
