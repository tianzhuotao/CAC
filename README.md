...
CAC is also found effective in **3D semantic segmentation**, achieving competitive performance against recent SOTA methods, and the implementation is available at [**PointCept**](https://github.com/Pointcept/Pointcept) that is a powerful and flexible codebase for point cloud perception research. 
