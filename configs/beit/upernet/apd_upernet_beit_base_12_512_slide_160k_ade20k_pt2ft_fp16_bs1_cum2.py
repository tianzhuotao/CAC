...
#### zhuotao's modification to AMP (pixed precision training)
optimizer_config = dict(type='GradientCumulativeFp16OptimizerHook', loss_scale=512., cumulative_iters=2)
# fp16 placeholder
fp16 = dict()


#### original AMP configuration
